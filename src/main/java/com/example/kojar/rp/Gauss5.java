...
public class Gauss5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gauss5);
        vr = new Verwaltung();
...
public void gaussRechnen() {
    ...
    if (gibtEsFehler) {
        ...
        ErgebnisseSpeichern(vr.gaussBerechnen(buffer.gListeZurueckgebenABCD(5)));
    }
}
    public void aktivieren() {
        if (buffer.gListeIsEmpty(5)) {
            gaussAktivieren();
        } else {
            gaussLesen();
        }
    ...
    public void gaussAktivieren() {
        ...
        EditText[][] edittextFeld = new EditText[5][6];
    ...
    public void gaussLesen() {
        ...
        EditText[][] edittextFeld = new EditText[5][6];
        Matrix m = buffer.gListeZurueckgebenABCD(5);
        edittextFeld[0][0] = (EditText) findViewById(R.id.editText1);
        edittextFeld[0][1] = (EditText) findViewById(R.id.editText2);
        edittextFeld[0][2] = (EditText) findViewById(R.id.editText3);
        edittextFeld[0][3] = (EditText) findViewById(R.id.editText4);
    ...
    public void keybordversteken(View v) {
        hideSoftKeyboard(Gauss5.this, v);
    }
    ...
    public void gaussErstellen() {
        ...
        String[][] stringFeld = new String[5][6];
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 6; j++) {
        ...
        double zahl = 0;
        Matrix m = vr.matrixErzeugen(5, 6);
