...
public class Gauss2 extends AppCompatActivity {
    ...
    public void gaussLesen() {
        EditText[][] edittextFeld = new EditText[2][3];
        Matrix m = buffer.gListeZurueckgebenABCD(2);
    ...
    public void keybordversteken(View v) {
        hideSoftKeyboard(Gauss2.this, v);
    }

    public void gaussVerwaltung(View v) {
        if (v.getId() == R.id.Gzurueck2) {
            buffer.schrittListeLeeren();
            buffer.gListeLeeren();
            Intent i = new Intent(getApplicationContext(), GaussEntscheider.class);
            startActivity(i);
        } else if (v.getId() == R.id.GerstellenOK2) {
            gaussRechnen();
        } else if (v.getId() == R.id.Gabbrechen2) {
            buffer.schrittListeLeeren();
            buffer.gListeLeeren();
            Intent i = new Intent(getApplicationContext(), GaussEntscheider.class);
            startActivity(i);
        } else if (v.getId() == R.id.Ginfo2) {
            gleichungenInfo();
        }
    }
    ...
    public void gaussRechnen() {
        ...
        if (gibtEsFehler) {
            ...
            ErgebnisseSpeichern(vr.gaussBerechnen(buffer.gListeZurueckgebenABCD(2)));
        }
    }
    ...
    public void gaussErstellen() {
        ...
        String[][] stringFeld = new String[2][3];
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 3; j++) {
        ...
        double zahl = 0;
        Matrix m = vr.matrixErzeugen(2, 3);
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 3; j++) {
                try {
